...
class WxController extends Controller
{
    ...
    public function wxlogin(){
        ...
        $url="https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx71cba979e28407f8&redirect_uri=".$a."&response_type=code&scope=snsapi_base&state=STATE&connect_redirect=1#wechat_redirect";
        header('location:'.$url);
    }
    public function wx(){
        $code=$_GET['code'];
